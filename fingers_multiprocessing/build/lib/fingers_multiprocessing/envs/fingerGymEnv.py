...
class FingerGymEnv(gym.Env):

    def __init__(self,renders=True,timeStep=1000,random_robot_start=False,
        ...
        self.current_step = 0
        self.max_episode_step = 1000 # an episode will terminate (end) if this number is reached
