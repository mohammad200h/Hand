...
class CoordinateFrameTrasform():
    ...
    def get_in_local_finger_frame(self,goalId,finger_name):
        self.get_state(goalId,finger_name)
        self.setup_tree()
        return self.get_state_in_local_frame()

    # utility function
    def get_state(self,goalId,finger_name):
        finger_pos,finger_orn = self.controller.get_complete_obs_finger_tip(finger_name)
